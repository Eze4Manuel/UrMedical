    ...
    return (
        <Fragment>
            <div className="my-3">
                ...
                <p className="user-info__detail"><span>Pickup</span> <span>{data?.pickup}</span></p>
                <p className="user-info__detail"><span>Destination</span> <span>{data?.destination}</span></p>
